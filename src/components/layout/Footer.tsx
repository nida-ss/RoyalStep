...
const Footer: React.FC = () => (
  <footer className="relative bg-primary text-white pt-16 pb-8 overflow-hidden">
    ...
    <div className="container mx-auto px-6 lg:px-12 max-w-7xl">
      <div className="grid grid-cols-1 lg:grid-cols-6 gap-10">
        ...
        <div className="lg:col-span-2 space-y-6">
          <div className="flex items-center space-x-3">
            ...
            <div>
              <h2 className="text-2xl font-semibold">Royal Step</h2>
              <p className="text-sm text-[#FB6609] font-medium">Connect IT Perfectly</p>
            </div>
          </div>
          ...
          <div className="space-y-4 text-sm text-white/80">
            ...
            <div className="flex items-center space-x-3">
              ...
              <span className="text-white/80">Support@RoyalStep.ae</span>
            </div>
          </div>

          {/* Social */}
          <div className="flex space-x-3">
            {['instagram','linkedin','behance','twitter'].map((icon) => (
              <a
                key={icon}
                href="#"
                className="w-8 h-8 rounded-full border border-[#FB6609] flex items-center justify-center hover:bg-[#FB6609]/20 transition"
              >
                <svg /* {icon} SVG path */ />
              </a>
            ))}
      ...
      {/* Bottom Bar */}
      <div className="mt-12 pt-6 border-t border-white/20 flex flex-col md:flex-row items-center justify-between text-white/50 text-xs">
